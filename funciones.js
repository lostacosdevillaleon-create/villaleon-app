...
// Resetear puntos de cliente a 0
...
async function registrarCobroPremio(clienteId, clienteNombre, premioId, premioNombre, puntosCanjeados, puntosTotalesCliente) {
    try {
        console.log('💰 Registrando cobro de premio:', {
            clienteId, clienteNombre, premioId, premioNombre, puntosCanjeados, puntosTotalesCliente
        });
            ...
            .insert([
                {
                    ...
                    puntos_totales_cliente: puntosTotalesCliente,
...
function exportarACSV(datos, nombreArchivo = 'historial_canjes.csv') {
    ...
    // Encabezados CSV
    const headers = ['Fecha', 'Cliente', 'Email', 'Premio', 'Puntos Canjeados', 'Puntos Totales del Cliente'];
        ...
        <body>
            <table border="1">
                <tr style="background-color: #D32F2F; color: white; font-weight: bold;">
                    ...
                    <th>Puntos Totales del Cliente</th>
